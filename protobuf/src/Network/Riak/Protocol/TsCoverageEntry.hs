...
instance P'.Wire TsCoverageEntry where
  ...
  wirePut ft' self'@(TsCoverageEntry x'1 x'2 x'3 x'4)
   = case ft' of
       10 -> put'Fields
       11 -> do
