...
instance P'.Wire TsGetResponse where
  ...
  wirePutWithSize ft' self'@(TsGetResponse x'1 x'2)
   = case ft' of
       10 -> put'Fields
       11 -> put'FieldsSized
