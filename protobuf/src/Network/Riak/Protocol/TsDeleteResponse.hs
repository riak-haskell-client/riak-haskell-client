...
instance P'.Wire TsDeleteResponse where
  wireSize ft' self'@(TsDeleteResponse)
   = case ft' of
    ...
    where
        calc'Size = 0
  wirePutWithSize ft' self'@(TsDeleteResponse)
   = case ft' of
       10 -> put'Fields
       11 -> put'FieldsSized
