...
instance P'.Wire SearchQueryResponse where
  ...
  wirePutWithSize ft' self'@(SearchQueryResponse x'1 x'2 x'3)
   = case ft' of
       10 -> put'Fields
       11 -> put'FieldsSized
    ...
    where
        put'Fields
         = P'.sequencePutWithSize [P'.wirePutRepWithSize 10 11 x'1, P'.wirePutOptWithSize 21 2 x'2, P'.wirePutOptWithSize 24 13 x'3]
        put'FieldsSized
