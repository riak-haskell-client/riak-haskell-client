...
instance P'.Wire YzSchemaGetResponse where
  ...
  wirePutWithSize ft' self'@(YzSchemaGetResponse x'1)
   = case ft' of
       10 -> put'Fields
       11 -> put'FieldsSized
