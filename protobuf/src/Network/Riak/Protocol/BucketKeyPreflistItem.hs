...
instance P'.Wire BucketKeyPreflistItem where
  ...
  wirePutWithSize ft' self'@(BucketKeyPreflistItem x'1 x'2 x'3)
   = case ft' of
       10 -> put'Fields
       11 -> put'FieldsSized
    ...
    where
        put'Fields
         = P'.sequencePutWithSize [P'.wirePutReqWithSize 8 3 x'1, P'.wirePutReqWithSize 18 12 x'2, P'.wirePutReqWithSize 24 8 x'3]
        put'FieldsSized
