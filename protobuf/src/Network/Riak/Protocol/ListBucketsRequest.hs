...
instance P'.Wire ListBucketsRequest where
  ...
  wirePutWithSize ft' self'@(ListBucketsRequest x'1 x'2 x'3)
   = case ft' of
       10 -> put'Fields
       11 -> put'FieldsSized
    ...
    where
        put'Fields
         = P'.sequencePutWithSize [P'.wirePutOptWithSize 8 13 x'1, P'.wirePutOptWithSize 16 8 x'2, P'.wirePutOptWithSize 26 12 x'3]
        put'FieldsSized
