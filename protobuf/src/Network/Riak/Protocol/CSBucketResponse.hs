...
instance P'.Wire CSBucketResponse where
  ...
  wirePutWithSize ft' self'@(CSBucketResponse x'1 x'2 x'3)
   = case ft' of
       10 -> put'Fields
       11 -> put'FieldsSized
    ...
    where
        put'Fields
         = P'.sequencePutWithSize [P'.wirePutRepWithSize 10 11 x'1, P'.wirePutOptWithSize 18 12 x'2, P'.wirePutOptWithSize 24 8 x'3]
        put'FieldsSized
