...
instance P'.Wire TsColumnDescription where
  ...
  wirePut ft' self'@(TsColumnDescription x'1 x'2)
   = case ft' of
       10 -> put'Fields
       11 -> do
